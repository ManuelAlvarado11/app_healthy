...
class CategoriaAlimentacionScreen extends StatelessWidget {
  static const routeName = 'categoria-alimentacion-screen';

  const CategoriaAlimentacionScreen({super.key});
...
class _CategoriasList extends ConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Flexible(
      child: provider.categorias.isEmpty
          ...
          : RefreshIndicator(
              onRefresh: () async {
                ref.read(alimentacionProvider.notifier).getCategorias();
              },
              ...
              child: ListView(
                ...
                shrinkWrap: true,
                children: [
                  ...provider.categorias.toList().map((categoria) {
